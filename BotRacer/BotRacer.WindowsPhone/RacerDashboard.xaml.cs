...
namespace BotRacer.Phone
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class RacerDashboard : Page
    {
        public Racer Device { get; private set; }

        public RacerDashboard()
        {
